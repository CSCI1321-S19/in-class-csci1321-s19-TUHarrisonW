...
class Board {
  private var _elements = List.tabulate[BoardElement](10) ( i =>
    new Virus(util.Random.nextInt(8), util.Random.nextInt(15), DrMarioColor.random))
  private var _currentPill = new Pill(List(new PillPiece(3, 0, DrMarioColor.random()),
      new PillPiece(4, 0, DrMarioColor.random())))
  private var _nextPill = new Pill(List(new PillPiece(3, 0, DrMarioColor.random()),
      new PillPiece(4, 0, DrMarioColor.random())))
